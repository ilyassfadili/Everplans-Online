...
/**
 * The purchase-success confirmation screen (Prompt 6 Phase 2) - what a
 ...
 * `budget-planner/checkout/success/page.tsx`.
 */
  ...
  return (
    <Container size="narrow" className="flex flex-1 flex-col justify-center py-10 md:py-14">
      <EmptyState
        ...
        description={`${TRAVEL_PLANNER_PRODUCT.name} is now yours - a one-time payment, permanent access, no subscription. You can set up your trip whenever you're ready.`}
        action={<Button href="/app/travel-planner">Open Travel Planner</Button>}
      />
    </Container>
  );
}
