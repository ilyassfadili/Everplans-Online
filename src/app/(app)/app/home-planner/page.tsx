...
/**
 * The Home Dashboard (Everplans Home Planner Prompt 1 Phase 3) - "Your
 * home, organized and under control." `getHomeForCurrentUser()` gates the
 * route (it calls `requireUser()` internally): no home yet sends the
 * visitor to setup, the same "workspace exists?" gate `TravelPlannerPage`/
 * `WeddingPlannerPage` already use.
 *
