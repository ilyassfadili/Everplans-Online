...
// `travel-planner/_components/panel-header.tsx` already establishes.
...
/**
 * The Home Planner dashboard's shared panel heading - a colored icon chip
 ...
 * "one per hand-built product's dashboard" convention Travel/Wedding
 * Planner's own copies already establish.
 */
