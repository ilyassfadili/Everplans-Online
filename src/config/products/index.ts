...
import { homePlannerLanding } from "./home-planner";
 ...
 * `life-planner.ts`/`home-planner.ts` - the route and every section
 * component already read through this registry, so nothing else changes.
 */
const productLandingConfigs: Record<string, ProductLandingConfig> = {
  ...
  [homePlannerLanding.slug]: homePlannerLanding,
};
